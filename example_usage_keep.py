...
for account in subaccounts:
    print(f"Name: {account['friendly_name']}, SID: {account['sid']}, Auth Token: {account['auth_token']}")
...
manager.transfer_phone_number(source_account_sid=account_sid, phone_number_sid="PNxxx", target_account_sid="ACxxx")
